...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["account-account-module"], {
  ...
  function srcAppAccountLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginComponent = /*#__PURE__*/function () {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.accountService.login(this.loginForm.value).subscribe(function (response) {
    ...
    LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 10,
      vars: 5,
      consts: [[1, "d-flex", "justify-content-center", "mt-5"], [1, "col-3"], ["autocomplete", "off", 3, "formGroup", "ngSubmit"], [1, "text-center", "mb-4"], [1, "h3", "mb-3", "font-weight-normal"], ["formControlName", "email", 3, "label"], ["formControlName", "password", 3, "label", "type"], ["type", "submit", 1, "btn", "btn-lg", "btn-primary", "btn-block", 3, "disabled"]],
      ...
      _createClass(RegisterComponent, [{
        ...
        value: function createRegisterForm() {
          this.registerForm = this.fb.group({
            ...
            password: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_1__["Validators"].pattern("(?=^.{6,10}$)(?=.*d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&amp;*()_+}{&quot;:;'?/&gt;.&lt;,])(?!.*s).*$")]]
          });
        }
      }]);
